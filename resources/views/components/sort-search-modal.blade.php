                    ...
                    <form action="" id="sortService">
                        <div class="row row-cols-2 mx-0">
                            <div class="form-check col mb-3">
                                <input class="form-check-input" type="radio" name="sort-by" id="sortRadio1" value="1">
                                <label class="form-check-label" for="sortRadio1">
                                    Name Ascending
                                </label>
                            </div>
                            <div class="form-check col mb-3">
                                <input class="form-check-input" type="radio" name="sort-by" id="sortRadio2" value="2">
                                <label class="form-check-label" for="sortRadio2">
                                    Name Descending
                                </label>
                            </div>
                            <div class="form-check col mb-3">
                                <input class="form-check-input" type="radio" name="sort-by" id="sortRadio3" value="3">
                                <label class="form-check-label" for="sortRadio3">
                                    Price Ascending
                                </label>
                            </div>
                            <div class="form-check col mb-3">
                                <input class="form-check-input" type="radio" name="sort-by" id="sortRadio4" value="4">
                                <label class="form-check-label" for="sortRadio4">
                                    Price Descending
                                </label>
                            </div>
                            <div class="form-check col mb-3">
                                <input class="form-check-input" type="radio" name="sort-by" id="sortRadio5" value="5">
                                <label class="form-check-label" for="sortRadio5">
                                    Rating Ascending
                                </label>
                            </div>
                            <div class="form-check col mb-3">
                                <input class="form-check-input" type="radio" name="sort-by" id="sortRadio6" value="6">
