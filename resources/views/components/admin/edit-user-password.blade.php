<div class="modal fade" id="editUserPasswordModal{{ $loop->iteration }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <h2 id="editUserPasswordModalHeader">Edit User Password</h2>
                    <form method="POST" id="editUserPasswordForm" action="/edit-user-password">
                        @csrf
                        @method('PUT')
