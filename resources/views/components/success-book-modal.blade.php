<div class="modal show" id="successBookModal" tabindex="-1" aria-labelledby="successBookModalLabel">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <h2 id="successBookModalHeader" class="mb-4">Your Beauty Date Confirmed!</h2>
                    <p>Your booking is set, and the countdown to your pampering paradise has officially
                        begun! 💅💄</p>
