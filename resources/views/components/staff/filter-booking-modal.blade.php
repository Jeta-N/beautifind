                                ...
                                <div class="row mx-0">
                                    <div class="form-check col mb-3">
                                        <input class="form-check-input" type="checkbox" name="status[]"
                                            id="statusCheckboxDone" value="Done">
                                        <label class="form-check-label" for="statusCheckboxDone">
                                            Done
                                        </label>
                                    </div>
                                    <div class="form-check col mb-3">
                                        <input class="form-check-input" type="checkbox" name="status[]"
                                            id="statusCheckboxUpcoming" value="Upcoming">
                                        <label class="form-check-label" for="statusCheckboxUpcoming">
                                            Upcoming
                                        </label>
                                    </div>
                                    <div class="form-check col mb-3">
                                        <input class="form-check-input" type="checkbox" name="status[]"
                                            id="statusCheckboxCancelled" value="Cancelled">
                                        <label class="form-check-label" for="statusCheckboxCancelled">
                                            Cancelled
                                        </label>
                                    </div>
                                </div>
