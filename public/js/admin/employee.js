document.addEventListener('DOMContentLoaded', function () {
    var employeeFilter = document.getElementById('filterEmployeeForm');
    employeeFilter.addEventListener('submit', function (event) {
        ...
        window.location.href = '/admin-employees' + (urlParams.toString() ? '?' + urlParams.toString() : '');
    });
